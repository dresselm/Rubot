# Send data directly to the socket after filtering for glines and banned phrases
...
def send_data(s)
  ...
  if detected == 0      # If there was not a match for a filtered item
    if s.length <= 450  # If the text length is under 450 characters
